...
#define BUILD_TARGET_TC1
#ifdef BUILD_TARGET_TC1
/* ************************************************************************
 * For TC1 with ST7735 LCD and 328P
 * Size with Arduino 7.3.0-atmel3.6.1-arduino7 gcc compiler
 * Program:   32278 bytes (98.5% Full)
 * Data:        242 bytes (11.8% Full)
 * EEPROM:      746 bytes (72.9% Full)
 * ************************************************************************ */
#if F_CPU != 16000000UL
#error Wrong CPU frequency for TC1. Line 32 in Makefile must be "FREQ = 16"
#endif
#define UI_AUTOHOLD
#define POWER_OFF_TIMEOUT     30 // required ???
#define UI_PINOUT_ALT
#define UI_QUESTION_MARK
#define UI_ZENER_DIODE
...
#define HW_PROBE_ZENER
#undef ZENER_VOLTAGE_MAX
#define ZENER_VOLTAGE_MAX     25000     /* max. voltage in mV */
...
//LCD module:
/*
 * !!! For TC1 LCD_ST7735 must be enabled at line 681 in config_328.h !!!
 */
#if !defined(LCD_RES)
#error LCD_ST7735 must be enabled at line 681 in config_328.h and LCD_ST7565R must be disabled at the lines before
#endif
#undef LCD_RES
#undef LCD_DC
#undef LCD_SDA
